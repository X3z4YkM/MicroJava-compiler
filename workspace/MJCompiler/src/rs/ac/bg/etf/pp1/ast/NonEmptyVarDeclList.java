...
public class NonEmptyVarDeclList extends VarDeclList {

    private VarDeclList VarDeclList;
    private VarDeclElem VarDeclElem;

    public NonEmptyVarDeclList (VarDeclList VarDeclList, VarDeclElem VarDeclElem) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NonEmptyVarDeclList(\n");
